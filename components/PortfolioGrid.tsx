...
export const PortfolioGrid = (props:PortfolioGridProps) => {
    ...
    const { img, content, url, reverse, left, title, cur, showIndex } = props
  ...
  return (
    <Flex flexDirection={{base:'column', md:reverse?'row-reverse': 'row'}} mb={20} position='relative' width={{base:'100%', md:'80%'}}>
        ...
        <Box rounded={'lg'} width={{base:'100%', md:'100%', lg:'70%', xl:'58.5'}} as='a' href={url} target='_blank' minH={'fit-content'} bgColor='none' position='relative' >
